<template>
  <div class="screen-container" :style="containerStyle">
    <header class="screen-header">
      ...
      <span class="title">区块链风险监控平台</span>
    ...
    <div class="screen-body">
      ...
      <section class="screen-right">
        ...
        <div id="right-bottom" :class="[fullScreenStatus.radar ? 'fullscreen' : '']">
          <!-- 风险类型图表 -->
          <Radar ref="radar"></Radar>
          <div class="resize">
            <!-- icon-compress-alt -->
            <span @click="changeSize('radar')"  :class="['iconfont', fullScreenStatus.radar ? 'icon-compress-alt' : 'icon-expand-alt']"></span>
          </div>
        </div>
      </section>
    </div>
